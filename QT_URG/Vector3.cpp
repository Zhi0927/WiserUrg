...
vector3::vector3(const float vx, const float vy, const float vz) : x(vx), y(vy), z(vz) { }
...
vector3 vector3::SmoothDamp(vector3 current, vector3 target, vector3& currentVelocity, float smoothTime, float deltaTime) {
